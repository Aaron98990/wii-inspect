...
My stamps, high scores, and previous data.bin (encrypted save file) and Sports2.dat (unencrypted save file generated by the tachtig tool) are in the personal/ folder. For reference, they look similar to the below pictures (pictures are out of date).
