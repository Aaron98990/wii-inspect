...
About
- Retrieve high scores, skill levels, dates of received stamps, and the last 25 recent activity from the save file for Wii Sports Resort.

My stamps, high scores, and previous data.bin (encrypted save file) and Sports2.dat (deencrypted save file generated by the tachtig tool) are in the personal/ folder. For reference, they look similar to the below pictures (pictures are out of date).
