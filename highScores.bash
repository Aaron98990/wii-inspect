...
echo -e "${GREEN}Player 1 Personal Records${SET}"
i=`doc 8a6e`
printf 'Power Crusing: %s %s %s %s %s %s\n' `toDec ${hex:i:4} 10` `toDec ${hex:$((i+8)):4} 10` `toDec ${hex:$((i+16)):4} 10` `toDec ${hex:$((i+24)):4} 10` `toDec ${hex:$((i+32)):4} 10` `toDec ${hex:$((i+40)):4} 10`
i=`doc 8a96`
printf 'Archery (Easy, Medium, Hard): %d %d %d\n' 0x${hex:i:4} 0x${hex:$((i+8)):4} 0x${hex:$((i+16)):4}
i=`doc 8abe`
printf 'Frisbee Dog: %d\n' 0x${hex:i:4}
i=`doc 8ae6`
printf '3 Point Contest: %s\n' `toDec ${hex:i:4} 10`
printf 'Bowling (10, 100, Spin): %d %d %d\n' 0x${hex:`doc 8b0e`:4} 0x${hex:`doc 8b36`:4} 0x${hex:`doc 8b5e`:4}  
i=`doc 8b86`
printf 'Canoeing (Target Distance): %s (%s), %s (%s), %s (%s)\n' `toDec ${hex:i:4} 100` `toDec ${hex:$((i+8)):4} 100` `toDec ${hex:$((i+16)):4} 100` `toDec ${hex:$((i+24)):4} 100` `toDec ${hex:$((i+32)):4} 100` `toDec ${hex:$((i+40)):4} 100`

printf 'Return Table Tennis: %d\n' 0x${hex:`doc 8bae`:4}
i=`doc 8bd6`
printf 'Wakeboarding: %d %d %d\n' 0x${hex:i:4} 0x${hex:$((i+8)):4} 0x${hex:$((i+16)):4}
printf 'Golf (Resort A-C, Classic A-C, Special): '
nn=`doc 8c26`
for bb in {1..10}
do
twos ${hex:nn:4};
